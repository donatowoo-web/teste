...
export const metadata = {
  title: "Obrigado | EVAPLACE - Construção em Aço Leve LSF",
  description: "Obrigado pelo seu contacto. A nossa equipa de especialistas em construção LSF entrará em contacto brevemente.",
};
        ...
        <div className={styles.container}>
          <FadeInOnScroll y={30} blur={8} durationMs={700}>
            ...
            <p className={styles.subtitle}>
              E agora? Vamos entrar em contacto dentro de 24h.<br />
              Até lá pode ver como funciona o método da Evaplace.
            </p>
          </FadeInOnScroll>
        </div>
      </section>
